 ...
 */
public class PrinterSidePanelController implements SidePanelManager, PrinterListChangesListener {
	...
	@FXML
	private PrinterGrid printerGridComponent;
	...
	@Inject
	protected PrinterSidePanelController(
			I18N i18n,
	...
	private void bindHeadProperties(Head head) {
		if (head.getNozzleHeaters().size() > 0) {
			...
			if (head.headTypeProperty().get() == Head.HeadType.SINGLE_MATERIAL_HEAD) {
				...
				legendMaterial2.textProperty().bind(Bindings
						...
						.otherwise("2: " + i18n.t("printerStatus.tempOutOfRangeLow")));
			}
		...
		headTitleBold.setText(i18n.t("headPanel." + head.typeCodeProperty().get() + ".titleBold"));
		headTitleLight.setText(i18n.t("headPanel." + head.typeCodeProperty().get() + ".titleLight"));
		headDescription.setText(i18n.t("headPanel." + head.typeCodeProperty().get() + ".description"));
		headNozzles.setText(i18n.t("headPanel." + head.typeCodeProperty().get() + ".nozzles"));
		headFeeds.setText(i18n.t("headPanel." + head.typeCodeProperty().get() + ".feeds"));
	...
	private void controlDetailsVisibility() {
		...
		Printer connectedPrinter = selectedPrinter.get();

...
public class ChartManager {
	...
	private void updateLegend() {
		String degreesC = i18n.t("misc.degreesC");
		String legendBedText = i18n.t("printerStatus.temperatureGraphBedLabel");
		String legendAmbientText = i18n.t("printerStatus.temperatureGraphAmbientLabel");

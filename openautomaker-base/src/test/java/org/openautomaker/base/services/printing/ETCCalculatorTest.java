...
//TODO: Revisit test tp see if there is anything useful.  This has been commented previously.
public class ETCCalculatorTest {
	...
	//
	//		testPrinter = new HardwarePrinter(null, new VirtualPrinterCommandInterface(null, printerHandle, false, 500));
	//

...
@Singleton
public class RequiredFirmwareVersionPreference extends APreference<Semver> {
	...
	@Inject
	protected RequiredFirmwareVersionPreference(
	...
	public Semver getValue() {
		return new Semver(applicationProperties.get(OPENAUTOMAKER_REQUIRED_FIRMWARE_VERSION) + ".0.0");
	}
